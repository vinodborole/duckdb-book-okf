...
description: Connecting to DuckDB DuckDB connection overview Quack remote protocol
  Client APIs C C++ CLI (command line interface) Go Java (JDBC) Node.js ODBC Python
...
1. Source page: https://duckdb.org/docs/current
