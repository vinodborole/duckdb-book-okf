...
description: Connecting to DuckDB DuckDB connection overview Client APIs C C++ CLI
  (command line interface) Go Java (JDBC) Node.js ODBC Python R Rust WebAssembly All
...
1. Source page: https://duckdb.org/docs/lts
