...
This is done through the `duckdb.connect` method.
...
notuse`executemany`to insert large amounts of data into DuckDB. See the data ingestion page for better options.
