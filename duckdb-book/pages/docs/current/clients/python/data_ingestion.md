...
### 
        ...
        [Pandas DataFrames – ](#pandas-dataframes--object-columns)`object` Columns
        
      

    
`object` Columns`pandas.DataFrame` columns of an `object` dtype require some special care, since this stores values of arbitrary type.
