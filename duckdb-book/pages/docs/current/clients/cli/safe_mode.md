...
- The following [dot commands](/docs/current/clients/cli/dot_commands.html) are disabled:
  - `.cd`
  - `.excel`
  - `.import`
  - `.log`
...
- The [`getenv` function](/docs/current/clients/cli/overview.html#reading-environment-variables) is disabled.
- The [`enable_external_access` option](/docs/current/configuration/overview.html#configuration-reference) is set to`false` . This implies that:
