...
## 
        ...
        [Return the Result of the Last Query Using ](#return-the-result-of-the-last-query-using-_)`_`
        
      

    
`_`You can use the `_` (underscore) table to query the result of the last query:
