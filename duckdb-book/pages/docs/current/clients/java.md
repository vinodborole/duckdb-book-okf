...
description: Installation To use the DuckDB Java (JDBC) client, visit the Java installation
  ...
  }}{% endif %}. Installation The DuckDB Java JDBC API can be installed from Maven
  Central. Please see the installation page for details. Basic API Usage DuckDB's
  JDBC API implements the main parts of the standard Java Database Connectivity (JDBC)
...
1. Source page: https://duckdb.org/docs/current/clients/java
