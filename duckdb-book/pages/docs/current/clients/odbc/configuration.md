...
This page documents the files using the ODBC configuration, `odbc.ini` and `odbcinst.ini`.
...
For platform-specific details, see the pages for Linux, macOS, and Windows.
