...
- 
  ...
  Installation To use the DuckDB ODBC client, visit the [ODBC installation page](/install/?environment=odbc).

The latest stable version of the DuckDB ODBC client is 1.5.5.
