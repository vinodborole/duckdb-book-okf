...
## 
        ...
        [Use ](#use-copy-when-loading-data-into-a-table)`COPY` When Loading Data into a Table
        
      

    
`COPY` When Loading Data into a TableThe [ COPY statement](/docs/current/sql/statements/copy.html) copies data directly into a table. The CSV reader uses the schema of the table instead of auto-detecting types from the file. This speeds up the auto-detection, and prevents mistakes from being made during auto-detection.
