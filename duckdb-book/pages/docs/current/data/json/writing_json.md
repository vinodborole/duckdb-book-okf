---
type: Web Page
title: Writing JSON – DuckDB
description: 'The contents of tables or the result of queries can be written directly
  to a JSON file using the COPY statement. For example: CREATE TABLE cities AS FROM
  (VALUES (''Amsterdam'', 1), (''London'', 2)) cities(name, id); COPY cities TO ''cities.json'';
...
1. Source page: https://duckdb.org/docs/current/data/json/writing_json
