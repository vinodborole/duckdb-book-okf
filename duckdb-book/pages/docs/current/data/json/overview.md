...
## 
  ...
  Warning Following [PostgreSQL's conventions](/docs/current/sql/dialect/postgresql_compatibility.html), DuckDB uses 1-based indexing for its [`ARRAY`](/docs/current/sql/data_types/array.html) and [`LIST`](/docs/current/sql/data_types/list.html) data types but [0-based indexing for the JSON data type](https://www.postgresql.org/docs/17/functions-json.html#FUNCTIONS-JSON-PROCESSING).
