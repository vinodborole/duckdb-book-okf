...
If you would like to install or load it manually, please consult the [“Installing and Loading” page](/docs/current/data/json/installing_and_loading.html).
...
## 
        ...
        [JSONPath and JSON Pointer Syntax](#jsonpath-and-json-pointer-syntax)
...
[PostgreSQL's conventions](/docs/current/sql/dialect/postgresql_compatibility.html), DuckDB uses 1-based indexing for its[and](/docs/current/sql/data_types/array.html)`ARRAY`[data types but](/docs/current/sql/data_types/list.html)`LIST`[0-based indexing for the JSON data type](https://www.postgresql.org/docs/17/functions-json.html#FUNCTIONS-JSON-PROCESSING).
...
```
Alternatively, create a table without specifying the schema manually with a [ CREATE TABLE ... AS SELECT clause](/docs/current/sql/statements/create_table.html#create-table--as-select-ctas):
...
### 
        ...
        [Retrieving JSON Data](#retrieving-json-data)
...
### 
        ...
        [Using Quotes for Special Characters](#using-quotes-for-special-characters)
